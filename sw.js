const CACHE_NAME='muscle-master-v18';
const APP_SHELL=[
  './','./index.html','./design-match.css',
  './app-core.js','./quest-core.js','./trainer-data.js','./app.js','./trainer-runtime.js','./training-session-core.js','./training-session-runtime.js','./training-session-presentation.js','./manifest.json','./data/quests/core.json',
